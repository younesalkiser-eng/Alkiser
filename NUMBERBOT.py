...
def send_welcome(message):
    ...
    if is_maintenance_mode() and not is_admin(user_id):
        maintenance_caption = (
            "<b>❍─── <u>𝐖𝐞𝐥𝐜𝐨𝐦 𝐭𝐨  يونس القيصر  😍💪 𝐵𝑂𝑇</u> ───❍</b>\n\n"
    ...
    fancy_text = (
        "<b>❍<u>𝐖𝐞𝐥𝐜𝐨𝐦 𝐭𝐨 يونس القيصر  𝑩𝑶𝑻 </u>❍</b>\n\n"
        "<b>🔋 <u>𝐅𝐚𝐬𝐭  • 𝐒𝐞𝐜𝐮𝐫𝐞  • 𝐨𝐧𝐥𝐢𝐧𝐞</u></b>\n\n"
        "<b>🎓 <u>𝐎𝐰𝐧𝐞𝐫</u>  • <a href='tg://user?id=7080140119'>يونس القيصر </a></b>\n\n"
        "<b>────────────────────</b>\n"
...
def handle_country_selection(call):
    ...
    # زر الجروب في الأعلى
    markup.add(types.InlineKeyboardButton("👥 𝐎𝐓𝐏 𝐆𝐑𝐎𝐔𝐏", url="https://t.me/you_k711"))
...
def change_number(call):
    ...
    markup.add(types.InlineKeyboardButton("👥 𝐎𝐓𝐏 𝐆𝐑𝐎𝐔𝐏", url="لينك جروب الاكواد🖤✨"))
...
def send_otp_to_user_and_group(date_str, number, sms):
    ...
    if user_id:
        try:
            markup = types.InlineKeyboardMarkup()
            markup.row(
                types.InlineKeyboardButton("𝐎𝐖𝐍𝐄𝐑✨", url="https://t.me/youk711"),
                types.InlineKeyboardButton("💬 𝐂𝐇𝐀𝐍𝐍𝐄𝐋", url="https://t.me/youk_711")
            )
            bot.send_message(
                user_id,
                f"""✨ <b><u> ♕يونس القيصر   ♕✨💛</u></b>\n🌍 <b>Country:</b> {safe_html(country_name)} {country_flag}\n⚙ <b>Service:</b> {safe_html(service)}\n☎ <b>Number:</b> {safe_html(number)}\n🕒 <b>Time:</b> {safe_html(date_str)}\n\n🔐 <b>Code:</b> {safe_html(otp_code)}\n\n<b>كود مقدم من يونس القيصر  {safe_html(service)} {safe_html(otp_code[:3])}-{safe_html(otp_code[3:])} ؟</b>""",
                reply_markup=markup,
                parse_mode="HTML"
            )
        except Exception as e:
    ...
    try:
        ...
        keyboard = {
            "inline_keyboard": [
                ...
                [
                    {"text": "💬 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ↗️", "url": "https://t.me/you_k711?si=WMRtRhEifcd1w3uH"},
